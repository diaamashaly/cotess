...
!function (e, t) {
    ...
    var s, u = (e = e && "default" in e ? e.default : e)(window), h = function () {
        ...
        var o = s.createTexture(), n = s.createFramebuffer();
    ...
    var d = function (t, r) {
        ...
        for (var a = h.arrayType, u = a ? new a(this.resolution * this.resolution * 4) : null, c = 0; c < 2; c++) {
            var d = s.createTexture(), f = s.createFramebuffer();
    ...
    d.DEFAULTS = {
        ...
        setupPointerEvents: function () {
            ...
            var e, i = this.$el.css("background-size"), o = this.$el.css("background-attachment"),
            ...
            if ("fixed" == o ? ((e = {
                ...
                s = this.backgroundWidth * a, h = this.backgroundHeight * a; else {
            ...
            s = this.context;
            var n = this.$el.innerWidth(), a = this.$el.innerHeight(), u = Math.max(n, a);
            r /= u;
            ...
            var e = this.$el.innerWidth(), t = this.$el.innerHeight();
    ...
    e.fn.ripples = function (t) {
        ...
        return this.each(function () {
            var i = e(this), o = i.data("ripples"), n = e.extend({}, d.DEFAULTS, i.data(), "object" == typeof t && t);
